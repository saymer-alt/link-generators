...
## 4. Сначала снять baseline самого VPS
...
## 5. Найти WARP / WireGuard endpoint с этого VPS
...
## 6. Найти MASQUE H3 / QUIC с этого VPS
...
## 7. Найти MASQUE H2 / TCP с этого VPS
...
## 8. Что означают SEEN AS и NODE на VPS
...
## 9. Узнать, какой proxy сейчас выбран
...
## 10. Проверить текущий выход через Mihomo
...
## 11. Сравнить текущие H3 и H2 один к одному
...
## 13. Проверить endpoint WARPSCOUT без Mihomo
...
## 14. Быстрый чек-лист для каждого VPS
